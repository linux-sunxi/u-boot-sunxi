...
#define LOW_LEVEL_SRAM_STACK		0x00007800 /* End of sram - 2048 bytes heap */
#define CONFIG_SPL_STACK		LOW_LEVEL_SRAM_STACK
#define CONFIG_SYS_SPL_MALLOC_START	LOW_LEVEL_SRAM_STACK
#define CONFIG_SYS_SPL_MALLOC_SIZE	0x00000800
