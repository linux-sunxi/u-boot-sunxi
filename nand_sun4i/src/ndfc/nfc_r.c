...
/*
__u32 NFC_CalRandomSeed(__u32 row_adr)
{

	__u32 random_seed, random_key, random_seed_temp;
	__u32 index;
	__u32 rotate_bit_num;
...
__s32 _read_retry_get_param(__u8 *para)
{
	__u32 i;
	__u32 cfg;
	__s32 ret = 0;
...
__s32 _read_retry_set_param(__u8 *para)
{
	__u32 i;
	__u32 cfg;
	__s32 ret = 0;
