...
struct __NandPhyInfoPar_t SamsungNandTbl[] =
{
    ...
    { {0xec, 0xde, 0xd5, 0x7e, 0x68, 0x44, 0xff, 0xff }, 2,    16,     128,     4096,   0x0d88,   974,    40,     4,   0x200e04,     0,     &PhysicArchiPara3 },   // 21nm sdr K9LCG08U0B
    //-----------------------------------------------------------------------------------------------------------------------------------
...
struct __NandPhyInfoPar_t HynixNandTbl[] =
{
    ...
    { {0xad, 0xde, 0x94, 0xda, 0x74, 0xff, 0xff, 0xff }, 1,    16,     256,     4096,   0x0188,   960,    40,     4,  0x020708,      0,    &PhysicArchiPara3 },   // H27UCG8T2A 20nm 8G
    { {0xad, 0xd7, 0x94, 0x91, 0x60, 0xff, 0xff, 0xff }, 1,    16,     256,     2048,   0x0188,   960,    40,     4,  0x030708,      0,    &PhysicArchiPara3 },   // H27UBG8T2C 20nm 4G
    { {0xad, 0xde, 0x94, 0xeb, 0x74, 0xff, 0xff, 0xff }, 1,    32,     256,     2048,   0x0188,   960,    40,     4,  0x030708,      0,    &PhysicArchiPara3 },   // H27UCG8T2B 20nm 8G
    //---------------------------------------------------------------------------------------------------------------------------
    { {0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff }, 0,     0,       0,        0,   0x0000,     0,     0,     0,      0,         0,   0                 },   // NULL
};
...
struct __NandPhyInfoPar_t MicronNandTbl[] =
{
    ...
    { {0x2c, 0x64, 0x44, 0x4B, 0xff, 0xff, 0xff, 0xff }, 1,	   16,	   256,	    4096,	0x0388,   950,    40,     5, 0x400301,  0,   &PhysicArchiPara4 },	// MT29F64G08CBABA
	//-------------------------------------------------------------------------------------------------------------------------
    { {0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff }, 0,     0,       0,        0,   0x0000,     0,     0,    0,     0,      0,      0              },   // NULL
};
