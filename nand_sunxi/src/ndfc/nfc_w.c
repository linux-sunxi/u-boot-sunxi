...
extern void _dma_config_start(__u8 rw,__u32 attr, __u32 src_addr, __u32 dst_addr, __u32 len);
...
//		attr = 0x2930280;
	...
	_dma_config_start(1,attr, (__u32)mainbuf, NAFC_REGS_BASE + NFC_REG_o_IO_DATA, pagesize);
...
//		attr = 0x2930280;
	...
	_dma_config_start(1,attr, (__u32)mainbuf, NAFC_REGS_BASE + NFC_REG_o_IO_DATA, 1024);
...
//	else
//		attr = 0x2800293;
	_dma_config_start(0,attr, NAFC_REGS_BASE + NFC_REG_o_IO_DATA, (__u32)mainbuf, pagesize);
...
//	else
//		attr = 0x2800293;
	_dma_config_start(0,attr, NAFC_REGS_BASE + NFC_REG_o_IO_DATA, (__u32)mainbuf, 1024);
