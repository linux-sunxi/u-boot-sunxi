...
struct __NandPhyInfoPar_t ToshibaNandTbl[] =
{
    ...
    { {0x98, 0xde, 0x84, 0x93, 0x72, 0xd7, 0xff, 0xff }, 1,    32,     256,     2048,   0x0580,   918,    20,     4, 0x100504,   3,   &PhysicArchiPara9},    // TC58TEG6DDJTA00
    //-------------------------------------------------------------------------------------------------------------------------
    { {0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff }, 0,     0,       0,        0,   0x0000,     0,     0,     0,     0,      0,        0         },   // NULL
};
...
struct __NandPhyInfoPar_t SandiskNandTbl[] =
{
	...
	{ {0x45, 0xde, 0xa4, 0x82, 0x76, 0xd7, 0xff, 0xff }, 1, 	16,		256, 	4096,	0x0188,   950,	  20,	  4,	  0x301409,   3,	&PhysicArchiPara0 },   // 008G
	//------------------------------------------------------------------------------------------------------------------------
	{ {0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff }, 0, 	0,		 0, 	   0,	0x0000, 	0,	   0,	  0,	  0,   0,		   0		},	 // NULL
};
