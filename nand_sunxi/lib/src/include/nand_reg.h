...
#define NAFC_REGS_BASE	 (NandIOBase[NandIndex])
...
#define NFC_REG_MDMA_ADDR          __REG( NAFC_REGS_BASE + NFC_REG_o_MDMA_ADDR          )
#define NFC_REG_DMA_CNT            __REG( NAFC_REGS_BASE + NFC_REG_o_DMA_CNT          )
