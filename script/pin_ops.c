...
****************************************************************************************************
*/
int gpio_script_init(void)          //gpio初始化函数接口
{
	debug("Init eGon pin module V2.0\n");
	gpio_g_pioMemBase = (__u32)SUNXI_PIO_BASE;

    //return script_parser_init((char *)(sys_cofig_data));
	return script_parser_init((char *)CONFIG_SCRIPT_DATA_BASE);
}
/*
****************************************************************************************************
*
...
****************************************************************************************************
*/
__s32 gpio_script_exit(void)		    //gpio退出函数接口
{
	return 0;
}
/*
...
__s32 gpio_release(u32 p_handler, __s32 if_release_to_default_status)
{
	...
	{
		debug("gpio module :  release p_handler = %x\n",p_handler);
