...
#define SUNXI_CCM_PLL1_CFG		(SUNXI_CCM_BASE + 0x00)
#define SUNXI_CCM_PLL1_TUN		(SUNXI_CCM_BASE + 0x04)
...
#define SUNXI_CCM_OSC24M_CFG		(SUNXI_CCM_BASE + 0x50)
#define SUNXI_CCM_CPU_AHB_APB0_CFG	(SUNXI_CCM_BASE + 0x54)
