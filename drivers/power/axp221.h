...
#define   BOOT_POWER22_LDO2OUT_VOL              (0x28)
#define   BOOT_POWER22_LDO3OUT_VOL              (0x29)
#define   BOOT_POWER22_LDO4OUT_VOL              (0x2A)
#define   BOOT_POWER22_LDO5OUT_VOL              (0x15)
#define   BOOT_POWER22_LDO6OUT_VOL              (0x16)
#define   BOOT_POWER22_LDO7OUT_VOL              (0x17)
#define   BOOT_POWER22_LDO8OUT_VOL              (0x18)
#define   BOOT_POWER22_LDO9OUT_VOL              (0x19)
#define   BOOT_POWER22_LDO10OUT_VOL              (0x1A)
#define   BOOT_POWER22_LDO11OUT_VOL              (0x1B)
