...
__s32 disp_video_init()
{
    ...
    maf_flag_mem[0][0] = OSAL_PhyAlloc(maf_flag_mem_len);
    maf_flag_mem[0][1] = OSAL_PhyAlloc(maf_flag_mem_len);
    maf_flag_mem[1][0] = OSAL_PhyAlloc(maf_flag_mem_len);
    maf_flag_mem[1][1] = OSAL_PhyAlloc(maf_flag_mem_len);
...
{
    OSAL_PhyFree(maf_flag_mem[0][0], maf_flag_mem_len);
    OSAL_PhyFree(maf_flag_mem[0][1], maf_flag_mem_len);
    OSAL_PhyFree(maf_flag_mem[1][0], maf_flag_mem_len);
    OSAL_PhyFree(maf_flag_mem[1][1], maf_flag_mem_len);
    memset(g_video,0,sizeof(g_video));
